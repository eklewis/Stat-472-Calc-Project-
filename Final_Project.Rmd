...
\begin{eqnarray}
\text{log} (\frac{p_i}{1-p_i}) &=& \beta_0 + \beta_1 X_{i1} + \beta_2 X_{i2} + \beta_3 X_{i3} + \beta_4 X_{i4} + \alpha_{\text{institution}} \\
p_i &=& \text{Probability of a student switching} \\
X_1 &=& \text{Gender of Student} \\
X_2 &=& \text{Gender of Professor} \\
X_2 &=& \text{Age of Professor} \\
X_4 &=& \text{Instrcutor Quality} \\
