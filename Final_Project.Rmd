...
```{r}
IQ <- select(datF, Q18Post_Applications, Q18Post_Appointments, Q18Post_AskedQs, Q18Post_Discouraged, Q18Post_Explanations, Q18Post_Listened, Q18Post_ProblemSolver, Q18Post_Time)



datF <- datF %>% mutate(Inst.Qual = apply(IQ,1,weighted.mean,rescale_load_iq[,1],na.rm = TRUE))
